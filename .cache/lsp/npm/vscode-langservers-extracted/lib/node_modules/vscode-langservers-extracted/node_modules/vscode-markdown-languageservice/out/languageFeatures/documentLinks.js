...
exports.looksLikeLinkToDoc = exports.createWorkspaceLinkCache = exports.parseLocationInfoFromFragment = exports.MdLinkProvider = exports.LinkDefinitionSet = exports.ReferenceLinkMap = exports.MdLinkComputer = exports.MdLinkKind = exports.resolveInternalDocumentLink = exports.HrefKind = void 0;
...
function looksLikeLinkToDoc(configuration, href, targetDoc) {
    if (href.path.fsPath === targetDoc.fsPath) {
        return true;
    }
    return configuration.markdownFileExtensions.some(ext => href.path.with({ path: href.path.path + '.' + ext }).fsPath === targetDoc.fsPath);
}
exports.looksLikeLinkToDoc = looksLikeLinkToDoc;
